...
# module references:
# CNN_accelerator, DVIClocking, ds_128, gray_128x128, jetson_controller, rgb2gray
...
proc create_root_design { parentCell } {
  ...
  set gpio_i [ create_bd_port -dir I gpio_i ]
  ...
  # Create instance: CNN_accelerator_1, and set properties
  set block_name CNN_accelerator
  set block_cell_name CNN_accelerator_1
  if { [catch {set CNN_accelerator_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CNN_accelerator_1 eq "" } {
  ...
  # Create instance: ds_128_0, and set properties
  set block_name ds_128
  set block_cell_name ds_128_0
  if { [catch {set ds_128_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ds_128_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: gray_128x128_0, and set properties
  set block_name gray_128x128
  set block_cell_name gray_128x128_0
  if { [catch {set gray_128x128_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gray_128x128_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: jetson_controller_0, and set properties
  set block_name jetson_controller
  set block_cell_name jetson_controller_0
  if { [catch {set jetson_controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $jetson_controller_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net AXI_GammaCorrection_0_m_axis_video [get_bd_intf_pins AXI_GammaCorrection_0/m_axis_video] [get_bd_intf_pins rgb2gray_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins gray_128x128_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins ds_128_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins gray_128x128_0/cap]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ds_128_0_m_axis [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins ds_128_0/m_axis]
  connect_bd_intf_net -intf_net gray_128x128_0_m_axis [get_bd_intf_pins gray_128x128_0/m_axis] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_vdma_1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net rgb2dvi_0_TMDS [get_bd_intf_ports hdmi_tx] [get_bd_intf_pins rgb2dvi_0/TMDS]
  connect_bd_intf_net -intf_net rgb2gray_0_m_axis [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins rgb2gray_0/m_axis]
  ...
  connect_bd_net -net CNN_accelerator_1_busy [get_bd_pins CNN_accelerator_1/busy] [get_bd_pins gray_128x128_0/busy]
  connect_bd_net -net CNN_accelerator_1_done [get_bd_pins CNN_accelerator_1/done] [get_bd_pins jetson_controller_0/done]
  connect_bd_net -net CNN_accelerator_1_img_raddr [get_bd_pins CNN_accelerator_1/img_raddr] [get_bd_pins gray_128x128_0/cnn_rd_addr]
  connect_bd_net -net CNN_accelerator_1_led [get_bd_ports led] [get_bd_pins CNN_accelerator_1/led]
  connect_bd_net -net CNN_accelerator_1_result [get_bd_pins CNN_accelerator_1/result] [get_bd_pins jetson_controller_0/result]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_150M/dcm_locked] [get_bd_pins rst_clk_wiz_0_50M/dcm_locked]
  ...
  connect_bd_net -net gpio_i_0_1 [get_bd_ports gpio_i] [get_bd_pins jetson_controller_0/gpio_i]
  connect_bd_net -net gray_128x128_0_cnn_rd_data [get_bd_pins CNN_accelerator_1/img_rdata] [get_bd_pins gray_128x128_0/cnn_rd_data]
  connect_bd_net -net gray_128x128_0_start [get_bd_pins CNN_accelerator_1/start] [get_bd_pins gray_128x128_0/start]
  connect_bd_net -net jetson_controller_0_cnn_enable [get_bd_pins gray_128x128_0/cnn_enable] [get_bd_pins jetson_controller_0/cnn_enable]
  connect_bd_net -net jetson_controller_0_gpio_o [get_bd_ports gpio_o] [get_bd_pins jetson_controller_0/gpio_o]
  connect_bd_net -net mm_clk_150 [get_bd_pins AXI_BayerToRGB_1/StreamClk] [get_bd_pins AXI_GammaCorrection_0/StreamClk] [get_bd_pins CNN_accelerator_1/sysclk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ds_128_0/aclk] [get_bd_pins gray_128x128_0/aclk] [get_bd_pins jetson_controller_0/clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins rgb2gray_0/aclk] [get_bd_pins rst_clk_wiz_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_150M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_50M/ext_reset_in] [get_bd_pins rst_vid_clk_dyn/ext_reset_in]
  connect_bd_net -net ref_clk_200 [get_bd_pins MIPI_D_PHY_RX_0/RefClk] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_0_50M/aux_reset_in]
  connect_bd_net -net rst_clk_wiz_0_150M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins rst_clk_wiz_0_150M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_0_150M_peripheral_aresetn [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins ds_128_0/aresetn] [get_bd_pins gray_128x128_0/aresetn] [get_bd_pins jetson_controller_0/resetn] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins rgb2gray_0/aresetn] [get_bd_pins rst_clk_wiz_0_150M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins AXI_BayerToRGB_1/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] [get_bd_pins CNN_accelerator_1/rst_n] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  ...
  connect_bd_net -net s_axil_clk_50 [get_bd_pins AXI_GammaCorrection_0/AxiLiteClk] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk] [get_bd_pins video_dynclk/s_axi_aclk] [get_bd_pins vtg/s_axi_aclk]
  connect_bd_net -net sw_0_1 [get_bd_ports sw] [get_bd_pins CNN_accelerator_1/sw]
