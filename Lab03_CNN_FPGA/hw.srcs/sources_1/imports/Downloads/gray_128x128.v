...
module gray_128x128 #(
    ...
    // Convert unsigned grayscale [0..255] to signed-centered int8 [-128..127]
    // for the CNN input path only.
    assign cnn_centered_data = port_data_q - 8'd128;

    always @(posedge aclk) begin
        cnn_rd_data <= cnn_centered_data;
    end
