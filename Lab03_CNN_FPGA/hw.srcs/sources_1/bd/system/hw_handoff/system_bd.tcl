...
# module references:
# DVIClocking, ds_128, gray_128x128, jetson_controller, rgb2gray
...
proc create_root_design { parentCell } {
  ...
  set frame_dropped_0 [ create_bd_port -dir O frame_dropped_0 ]
  ...
  # Create instance: CNN_16_core_1, and set properties
  set CNN_16_core_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:CNN_16_core:1.0 CNN_16_core_1 ]
  ...
  connect_bd_net -net CNN_16_core_1_busy [get_bd_pins CNN_16_core_1/busy] [get_bd_pins gray_128x128_0/busy]
  connect_bd_net -net CNN_16_core_1_img_raddr [get_bd_pins CNN_16_core_1/img_raddr] [get_bd_pins gray_128x128_0/cnn_rd_addr]
  connect_bd_net -net CNN_16_core_1_result [get_bd_pins CNN_16_core_1/result] [get_bd_pins jetson_controller_0/sw]
  ...
  connect_bd_net -net gray_128x128_0_cnn_rd_data [get_bd_pins CNN_16_core_1/img_rdata] [get_bd_pins gray_128x128_0/cnn_rd_data]
  connect_bd_net -net gray_128x128_0_frame_dropped [get_bd_ports frame_dropped_0] [get_bd_pins gray_128x128_0/frame_dropped]
  connect_bd_net -net gray_128x128_0_start [get_bd_pins CNN_16_core_1/start] [get_bd_pins gray_128x128_0/start]
  connect_bd_net -net jetson_controller_0_gpio_o [get_bd_ports gpio_o] [get_bd_pins jetson_controller_0/gpio_o]
  connect_bd_net -net jetson_controller_0_led [get_bd_ports led] [get_bd_pins jetson_controller_0/led]
  connect_bd_net -net mm_clk_150 [get_bd_pins AXI_BayerToRGB_1/StreamClk] [get_bd_pins AXI_GammaCorrection_0/StreamClk] [get_bd_pins CNN_16_core_1/sysclk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axi_lite_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ds_128_0/aclk] [get_bd_pins gray_128x128_0/aclk] [get_bd_pins jetson_controller_0/clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins rgb2gray_0/aclk] [get_bd_pins rst_clk_wiz_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_150M_peripheral_aresetn [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins rst_clk_wiz_0_150M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins AXI_BayerToRGB_1/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] [get_bd_pins CNN_16_core_1/rst_n] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ds_128_0/aresetn] [get_bd_pins gray_128x128_0/aresetn] [get_bd_pins jetson_controller_0/resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rgb2gray_0/aresetn] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins CNN_16_core_1/sw]
