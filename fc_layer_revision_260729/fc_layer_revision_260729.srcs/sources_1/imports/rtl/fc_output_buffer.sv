    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            case (bias_word_index)
                2'd0: begin
                    if (lane_valid[0]) begin
                        buffered_accumulator_0_s32 <=
                            $signed(buffered_accumulator_0_s32) +
                            $signed(bias_word[31:0]);
                    end
                    if (lane_valid[1]) begin
                        buffered_accumulator_1_s32 <=
                            $signed(buffered_accumulator_1_s32) +
                            $signed(bias_word[63:32]);
                    end
                end

                2'd1: begin
                    if (lane_valid[2]) begin
                        buffered_accumulator_2_s32 <=
                            $signed(buffered_accumulator_2_s32) +
                            $signed(bias_word[31:0]);
                    end
                    if (lane_valid[3]) begin
                        buffered_accumulator_3_s32 <=
                            $signed(buffered_accumulator_3_s32) +
                            $signed(bias_word[63:32]);
                    end
                end
                ...
                2'd2: begin
                    if (lane_valid[4]) begin
                        buffered_accumulator_4_s32 <=
                            $signed(buffered_accumulator_4_s32) +
                            $signed(bias_word[31:0]);
                    end
                    if (lane_valid[5]) begin
                        buffered_accumulator_5_s32 <=
                            $signed(buffered_accumulator_5_s32) +
                            $signed(bias_word[63:32]);
                    end
                end
                ...
                2'd3: begin
                    if (lane_valid[6]) begin
                        buffered_accumulator_6_s32 <=
                            $signed(buffered_accumulator_6_s32) +
                            $signed(bias_word[31:0]);
                    end
                    if (lane_valid[7]) begin
                        buffered_accumulator_7_s32 <=
                            $signed(buffered_accumulator_7_s32) +
                            $signed(bias_word[63:32]);
                    end
                end
