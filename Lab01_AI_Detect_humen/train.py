...
train_dataset = datasets.ImageFolder(root='./dataset_combined/train', transform=train_transform)
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True, num_workers=0, pin_memory=(device.type == 'cuda'))

val_dataset = datasets.ImageFolder(root='./dataset_combined/val', transform=val_transform)
